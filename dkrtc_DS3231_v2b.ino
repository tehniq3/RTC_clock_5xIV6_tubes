...
hour = now.hour();
minute = now.minute(); 
tt = (float)(rtc.getTemperature()+0.5) + dt;  // 
...
void loop() {
 ...
 //   Serial.println("tt");  
  ...
  ////////////////// Отображение температуры - нажмите и удерживайте кнопку -/temp ////// part added by niq_ro
  // Displays temperature - press and hold the +/sec button //
  if (analogRead(SW2) > 500 && menu == 0 && menu_svet == 0) 
  {
    w2 = 1; 
    a[0] = 10;    // blank
    a[1] = tt/10;
